...
export function Hero() {
  return (
    <section className="flex flex-col items-center text-center pt-24 pb-20 px-6 max-w-[1200px] mx-auto">
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-fey-charcoal border border-fey-mist/10 mb-8 shadow-[0_0_15px_rgba(0,0,0,0.5)]">
        <span className="text-fey-mist text-xs font-medium">
          🚀 Full-Stack Interview Preparation Platform
        </span>
      </div>

      <h1 className="text-5xl md:text-[54px] font-bold text-fey-white leading-[1.1] tracking-[-0.08em] max-w-3xl mb-6">
        Ace <span className="text-[#ffa16c]">JavaScript</span> &<br />
        Full-Stack Interviews.
      </h1>

      <p className="text-fey-graphite text-lg max-w-2xl mb-10 leading-relaxed">
